...
If your environment already has a fuller implementation pipeline (spec, review, docs, commit gates), use this skill only
to source graph safety-data for it. Otherwise, use it standalone: plan and execute a refactor with graph-backed
confidence.
