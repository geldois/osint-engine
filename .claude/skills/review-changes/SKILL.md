...
If your environment already has a fuller code-review workflow (multi-pass, correctness-focused), use this skill only to
source graph data for it. Otherwise, use it standalone: pull risk-aware, graph-backed context for reviewing a change.
