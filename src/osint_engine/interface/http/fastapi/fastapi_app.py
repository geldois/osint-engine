...
from osint_engine.interface.http.fastapi.routers.ceaf_router import build_ceaf_router
...
def build_fastapi_app(*, container: Container) -> FastAPI:
    ...
    fastapi_app.include_router(router=build_ceaf_router(container=container))
