...
@pytest.mark.asyncio
async def test_mem_node_repo_find_returns_node_when_node_exists(
    make_node: MakeNode, make_mem_storage: MakeMemStorage
) -> None:
    node = make_node()
...
@pytest.mark.asyncio
async def test_mem_node_repo_find_returns_none_when_node_does_not_exist(
    make_node: MakeNode, make_mem_storage: MakeMemStorage
) -> None:
    node = make_node()
...
@pytest.mark.asyncio
async def test_mem_node_repo_get_returns_node_when_node_exists(
    make_node: MakeNode, make_mem_storage: MakeMemStorage
) -> None:
    node = make_node()
    mem_storage = make_mem_storage(nodes=[node])
...
@pytest.mark.asyncio
async def test_mem_node_repo_save_persists_node_correctly(
    make_node: MakeNode, make_mem_storage: MakeMemStorage
) -> None:
    node = make_node()
    mem_storage = make_mem_storage()
...
@pytest.mark.asyncio
async def test_mem_node_repo_save_is_idempotent_and_does_not_overwrite(
    make_node: MakeNode,
) -> None:
    content = "test"
...
@pytest.mark.asyncio
async def test_mem_node_repo_save_many_persists_all_nodes(
    make_node: MakeNode, make_mem_storage: MakeMemStorage
) -> None:
    node_a = make_node()
    node_b = make_node()
...
@pytest.mark.asyncio
async def test_mem_node_repo_get_raises_when_node_does_not_exist(
    make_node: MakeNode, make_mem_storage: MakeMemStorage
) -> None:
    node = make_node()
    mem_storage = make_mem_storage()
